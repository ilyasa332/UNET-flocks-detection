...
### Run Demo
1- Download the train and test data from [this](https://drive.google.com/file/d/1Hrb1F7lzfVPqyzXJq-WQ46zSClk7ks0F/view?usp=sharing) 
2- Copy the zip folder to the colab files area
...
For training the model from scarch with your data follow the bellow steps:


For prediciting your data with our trainned model, follow the bellow steps: (to add the model file and the best epoch)
